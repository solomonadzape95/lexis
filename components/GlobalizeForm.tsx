...
export default function GlobalizeForm({
  ...
  return (
    ...
    >
      ...
      {/* Submit Button */}
      <SubmitButton className="w-full bg-primary hover:bg-primary/90 text-white py-5 rounded-xl font-bold text-lg flex items-center justify-center gap-3 shadow-xl shadow-primary/20 transition-all active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed">
        <svg
          aria-hidden="true"
          className="w-6 h-6"
          fill="currentColor"
